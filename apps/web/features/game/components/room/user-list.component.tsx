...
const UserListComponent = (props: IUserListProps) => {
  ...
  return (
    <ul className="fixed bottom-4 left-10 z-50 hidden h-auto w-1/6 flex-col items-center justify-center p-4 sm:bottom-auto sm:left-auto sm:right-10 sm:top-10 sm:flex">
